...
<html>
    ...
    <body>
        <div class="container">
            <form method="POST" action="upload.php">
                ...
                <div class="col-md-12">
                    ...
                    <button type="button" id="is-empty-button">Is empty?</button>
            ...
            <br/>
            <p>http://keith-wood.name/signature.html</p>
        </div>
        ...
        <script type="text/javascript">
            ...
            $('#is-empty-button').click(function() { 
                alert('Is empty? ' + sig.signature('isEmpty')); 
            });
        </script>
    </body>
</html>